...
function AddIndividuals() {
  ...
  const handleSubmit = async (values, { resetForm }) => {
    ...
    try {
      ...
      const response = await axiosInstance.post("/individual", formData, {
        headers: {
  ...
  return (
    <div>
      <AddPageHeroSection title="Add Individuals" />
      ...
      <div className="mt-28 max-w-4xl md:px-10 mx-auto p-8 flex flex-col items-center">
        ...
        <h1 className="text-center text-2xl md:text-4xl py-4 md:p-10 font-bold text-[#202E3B]">
          Provide The Details Of The Individual You Want To Add.
        </h1>
